...
//Example Code wurde von uns für die Anwendung erweitert

Servo myservo;

String myString, my2String;
int temp, humAir, humEarth, light,value;
char ch, ab;
      ...
      else if (myString.toInt() == 2)
      {
        ...
        while (1) {
          ...
          if (recvMsg(1000) == 0)
          {
            ...
            String recString = ((char*)recv_str);
            value = recString.toInt(); 
           // Serial.println(value);    
            if(value==2){
              //Serial.println("Bewässern");
myservo.write(180);
        delay(2000);
        myservo.write(90);
            }
             ...
             // String rec2String = ((char*)recv_str);
             // humAir = rec2String.toInt();
            
            //Serial.println(light);
            //Serial.println(humAir);
            //Serial.println("recHumAir");
            break;
          }
        }
      }
